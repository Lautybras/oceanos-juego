...
while not juego.haTerminado:
	...
	while juego.rondaEnCurso:
		...
		while not noSeQuierenJugarMásDúos:
			acciónDeDúos = acciónDeRobo = jugadores[juego.deQuienEsTurno].decidirAcciónDeDúos()
			if acciónDeRobo == Acción.Dúos.JUGAR_PECES:
				# Jugar dúo de peces
				pass
			elif acciónDeRobo == Acción.Dúos.JUGAR_BARCOS:
				# Jugar dúo de barcos
				pass
			elif acciónDeRobo == Acción.Dúos.JUGAR_CANGREJOS:
				# Jugar dúo de cangrejos
				pass
			elif acciónDeRobo == Acción.Dúos.JUGAR_NADADOR_Y_TIBURÓN:
				# Jugar dúo de nadador y tiburón
				pass
			elif acciónDeRobo == Acción.Dúos.NO_JUGAR:
				# No jugar dúos
