...
def test_001_AlCrearJuegoParaDosJugadores_JuegoNoHaTerminado():
	juego = EstadoDelJuego(cantidadDeJugadores=2)

	assert juego.haTerminado == False

def test_002_AlCrearJuegoParaDosJugadores_LosPuntajesDeJuegoInicianEnCero():
	juego = EstadoDelJuego(cantidadDeJugadores=2)
...
def test_003_AlCrearJuegoParaDosJugadores_ElPuntajeParaGanarEsCuarenta():
	juego = EstadoDelJuego(cantidadDeJugadores=2)

	assert juego.puntajeParaGanar() == 40

def test_004_AlCrearJuegoParaTresJugadores_ElPuntajeParaGanarEsTreintaYCinco():
	juego = EstadoDelJuego(cantidadDeJugadores=3)

	assert juego.puntajeParaGanar() == 35

def test_005_AlCrearJuegoParaTresJugadores_ElPuntajeParaGanarEsTreinta():
	juego = EstadoDelJuego(cantidadDeJugadores=4)

	assert juego.puntajeParaGanar() == 30

def test_006_NoSePuedeCrearJuegoParaMenosDeDosJugadores():
...
def test_007_NoSePuedeCrearJuegoParaMásDeCuatroJugadores():
