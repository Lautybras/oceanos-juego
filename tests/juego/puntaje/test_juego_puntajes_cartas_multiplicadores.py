...
def test_SiSeTieneUnCapitán_ElPuntajeEsCero():
	...
	juego._estadosDeJugadores[0].mano[Carta(Carta.Tipo.CAPITÁN, Carta.Color.BLANCO)] += 1
...
def test_SiSeTieneUnCardumenYUnDúoDePeces_ElPuntajeEsTres():
	juego = PartidaDeOcéanos(cantidadDeJugadores=2)
	juego.iniciarRonda()
...
def test_SiSeTieneUnCardumenYDosDúosDePeces_ElPuntajeEsSeis():
	juego = PartidaDeOcéanos(cantidadDeJugadores=2)
	juego.iniciarRonda()
...
def test_SiSeTieneUnFaroYUnDúoDeBarcos_ElPuntajeEsTres():
	juego = PartidaDeOcéanos(cantidadDeJugadores=2)
	juego.iniciarRonda()
...
def test_SiSeTieneUnFaroYDosDúosDeBarcos_ElPuntajeEsSeis():
	juego = PartidaDeOcéanos(cantidadDeJugadores=2)
	juego.iniciarRonda()
